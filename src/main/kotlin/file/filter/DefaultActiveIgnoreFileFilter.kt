...
import com.an5on.file.DefaultActiveIgnore
...
/**
 * An [IOFileFilter] that filters files based on the default active ignore patterns.
 *
 * This filter uses the patterns provided by [DefaultActiveIgnore] to determine whether a file or directory
 ...
 *
 * @see IOFileFilter
 * @see DefaultActiveIgnore
 * @since 0.1.0
 * @author Anson Ng <hej@an5on.com>
 */
object DefaultActiveIgnoreFileFilter : IOFileFilter {
    /**
     * Retrieves the set of [java.nio.file.PathMatcher] instances from [DefaultActiveIgnore].
     */
    private val defaultPathMatchers
        get() = DefaultActiveIgnore.ignorePathMatchers

    /**
     * Checks whether the specified file should be accepted.
     *
     * A file is accepted if it does not match any of the default active ignore patterns.
     *
