...
/**
 * An implementation of the [Ignorable] interface that provides default local state ignore patterns from the configuration.
 *
 ...
 */
object DefaultLocalIgnore : Ignorable {
