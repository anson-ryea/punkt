...
class PunktOptionGroupTest: PunktOptionGroup("Test Options") {
    ...
    @Test
    fun toChoicesTest() {
        val choices = Enum.Companion.toChoices<SampleEnum>()
...
//        val e1 = Enum.Companion.enumEntryOf<SampleEnum>("firstoption")
        val e2 = Enum.Companion.enumEntryOf<SampleEnum>("second-option")
        val e3 = Enum.Companion.enumEntryOf<SampleEnum>("third-option")
//        should fix
//        assertEquals(SampleEnum.FIRSTOption, e1)
    ...
    fun roundTripForToChoicesToEnumsToChoices() {
        val choices = Enum.Companion.toChoices<SampleEnum>()
        val roundTripped = choices.map { Enum.Companion.enumEntryOf<SampleEnum>(it) }
